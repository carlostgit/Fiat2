...
public:
    ...
    //Falta la definición
    void AddComplementaryComboPreferencesForPerson(wchar_t wc_person[256], wchar_t wc_complementary_combo[256], double d_maximum_satisfaction, double d_preference_at_0);
    void AddSupplementaryComboPreferencesForPerson(wchar_t wc_person[256], wchar_t wc_supplementary_combo[256], double d_maximum_satisfaction, double d_preference_at_0);
...
protected:
    ...
    std::map<std::string, strPreferencesCpp>& GetMapPerson_ComplementaryComboPreferences() {
        return m_mapPerson_ComplementaryComboPreferences;
    }

    std::map<std::string, strPreferencesCpp>& GetMapPerson_SupplementaryComboPreferences() {
        return m_mapPerson_SupplementaryComboPreferences;
    }
...
private:
    ...
    std::map<std::string, strPreferencesCpp> m_mapPerson_ComplementaryComboPreferences;
    std::map<std::string, strPreferencesCpp> m_mapPerson_SupplementaryComboPreferences;
