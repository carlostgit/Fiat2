...
void* GetPriceCalculatorRefFromDLL()
{
	return static_cast<void*>(pca::CPriceCalculatorStaticUser::GetPriceCalculatorRef());
}

pca::CPriceCalculator* GetPriceCalculatorRefFromDLL2()
{
	return pca::CPriceCalculatorStaticUser::GetPriceCalculatorRef();
}
