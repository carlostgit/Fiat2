...
int main()
{
    ...
    pca::CPriceCalculatorStaticUser::AddToPerson_SetSatisfactionCurveForOption("George", "nut_consumption", 1.4, 1.4);
    pca::CPriceCalculatorStaticUser::AddToPerson_SetSatisfactionCurveForOption("George", "chocolate_consumption", 1.5, 1.5);
    ...
    pca::CPriceCalculatorStaticUser::PrintPricesEvolution();
